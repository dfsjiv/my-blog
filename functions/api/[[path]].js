...
import {
    handleChatRequest,
    isChatPath
} from "../lib/chat-api.mjs";
import {
    handleCommentRequest,
    isCommentPath
} from "../lib/comments-api.mjs";
import {
    handleKnowledgeCommentRequest,
    isKnowledgeCommentPath
} from "../lib/knowledge-comments-api.mjs";
...
export async function onRequest(context) {
    ...
    try {
        ...
        else if (isChatPath(url.pathname)) {
        ...
        else if (isCommentPath(url.pathname)) {
            response = await handleCommentRequest({
                request,
                env,
                url,
                jsonResponse,
        ...
        else if (isKnowledgeCommentPath(url.pathname)) {
            response = await handleKnowledgeCommentRequest({
                request,
                env,
                url,
                jsonResponse,
