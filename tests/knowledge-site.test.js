...
assert.match(site, /function showRouteTransition/);
assert.match(site, /function hideRouteTransition/);
assert.match(site, /routeNeedsTransition/);
assert.match(css, /@keyframes knowledge-page-cover/);
assert.match(css, /@keyframes knowledge-page-reveal/);
